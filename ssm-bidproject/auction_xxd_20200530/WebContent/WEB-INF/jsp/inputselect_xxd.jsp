...
<!-- main begin-->
  <div class="sale">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
	    ...
	    <div class="logout right"><a href="toPesServlet_xxd" title="我的拍卖">我的拍卖</a></div>
	     <div class="jz">
	     <form action="selectgoodsServlet_xxd" method="post" name="select">
	   <input type="text" name="GoodsName_xxd" placeholder="请输入拍品名称"/>
	    <button class="btnse" name="selectOnclik_xxd" type="submit">搜索</button>
	     <font color="red">  
			    <%= request.getSession().getAttribute("messege") == null   
			        ? "" : request.getSession().getAttribute("messege")   
			    %>  
    		</font>
	    </form>
	    </div>
  ...
  <div class="items">
      ...
      <c:forEach var="goods_xxd" items="${sessionScope.goodsList_xxd}">
	        ...
	        <li class="borderno red"><a href="goodsServlet_xxd?GoodsId_xxd=${goods_xxd.goodsId_xxd}">竞拍</a></li>
	      </ul>  
      </c:forEach>
