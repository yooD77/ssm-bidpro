...
<!-- main begin-->
  ...
  <form action="jingpaiServlet_xxd" method="post" name="saled">
	  <div class="top10 salebd">
	       ...
	       <input type="number"  class="inputwd" id="sale_xxd" name="sale_xxd" value="" onkeyup="validate()"/>
	       <input id="BidPrice_xxd" name="BidPrice_xxd" type="submit" value="竞 拍" class="spbg buttombg f14  sale-buttom" />
	       </p>
...
<!-- main end-->
    ...
    <script>
   function validate(){
	   var priceNow = parseInt(document.getElementById("sale_xxd").value);
	   var highestPrice = parseInt("${sessionScope.highestPrice_xxd}");
	   if(priceNow > highestPrice){
		   document.getElementById("msg").innerHTML="<font color='green'></font>";
		   document.getElementById("BidPrice_xxd").disabled = false;
	   }
	   else{
		   document.getElementById("msg").innerHTML="<font color='red'>不能低于最高竞拍价</font>";
		   document.getElementById("BidPrice_xxd").disabled = true;
	   }
   }
  </script>
